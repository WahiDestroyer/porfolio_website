    ...
    <section>
      <div className="container">
        <div className="py-25 flex flex-col items-center">
          <h2
            data-aos="fade-down"
            className="font-sans text-5xl font-semibold text-primary leading-14 pb-6"
          >
            Portfolio
          </h2>
          <p
            data-aos="fade-left"
            className="font-sans text-li-gray font-normal leading-6 text-base text-center"
          >
            There are many variations of passages of Lorem Ipsum available,
          </p>
          <p
            data-aos="fade-right"
            className="font-sans text-li-gray font-normal leading-6 text-base pb-18 text-center"
          >
