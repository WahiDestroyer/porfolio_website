    ...
    <section className="bg-[#F0F1F3]">
      <div className="container p-38 flex justify-between">
        <div className="max-w-[530px]">
          <h2 className="text-nav font-sans font-semibold text-5xl leading-14">
            What I do?
          </h2>
          <p className="font-sans text-lg font-normal text-li-gray leading-6 pt-6 pb-4">
          ...
          <p className="font-sans text-lg font-normal text-li-gray leading-6 pb-12">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla purus
