    ...
    <section>
      <div className="container">
        <div className="flex flex-col text-center items-center pb-25">
          <h2
            data-aos="fade-down"
            className="text-nav font-semibold font-sans text-5xl leading-14 pb-24"
          >
            Testimonial
          </h2>
          <p
            data-aos="fade-down"
            className="font-sans font-normal text-lg text-li-gray leading-6 pb-18 max-w-xl"
          >
          ...
          <p
            data-aos="zoom-in"
            className="font-sans text-lg font-medium leading-6 text-[#2B384C] max-w-[872px]"
          >
          ...
          <h4
            data-aos="fade-up"
            className="text-black text-lg leading-7 font-medium font-sans pb-2 pt-6"
          >
            Esther Howard
          </h4>
          <small
            data-aos="fade-up"
            className="text-black font-light text-base leading-6"
          >
