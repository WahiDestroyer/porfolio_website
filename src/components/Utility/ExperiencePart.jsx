...
const ExperiencePart = ({title}) => {
  return (
    <div className="p-8 bg-white hover:translate-x-2.5 hover:border-l-5 border-pink rounded-md transition-all duration-500 max-w-fit">
      <h2 className="text-primary text-2xl font-semibold font-sans">
        {title}
      </h2>
